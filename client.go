...
// interacting with the lablink-v4-client API. You should not instantiate this
...
// LABLINK_V4_CLIENT_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("LABLINK_V4_CLIENT_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("LABLINK_V4_CLIENT_API_KEY"); ok {
...
// environment (LABLINK_V4_CLIENT_API_KEY, LABLINK_V4_CLIENT_BASE_URL). The option
