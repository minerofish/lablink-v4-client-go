...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Bloodlab.ListExaminations(context.Background())
	if userAgent != fmt.Sprintf("LablinkV4Client/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Bloodlab.ListExaminations(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Bloodlab.ListExaminations(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Bloodlab.ListExaminations(deadlineCtx)
		if err == nil {
